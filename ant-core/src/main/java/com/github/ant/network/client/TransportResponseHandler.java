...
import com.github.ant.network.protocol.RpcFailure;
import com.github.ant.network.protocol.RpcResponse;
import com.github.ant.network.server.MessageHandler;
...
public class TransportResponseHandler extends MessageHandler<ResponseMessage> {
  ...
  public int numOutstandingRequests() {
    return outstandingRpcs.size() + (streamActive ? 1 : 0);
  }
