...
import com.github.ant.network.client.RpcResponseCallback
import com.github.ant.rpc.{IsolatedRpcEndpoint, RpcEndpoint, RpcEndpointAddress, RpcEndpointRef, RpcEnvStoppedException}
 ...
 */
private[netty] class Dispatcher(nettyEnv: NettyRpcEnv, numUsableCores: Int = 0) extends Logging {
  ...
  private def postMessage(
    ...
    val error = synchronized {
      ...
      if (stopped) {
        ...
        Some(new AntException(s"Could not find $endpointName."))
      } else {
