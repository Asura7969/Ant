 ...
 */
package com.github.ant.rpc.netty
...
import com.github.ant.network.TransportContext
import com.github.ant.network.client.{RpcResponseCallback, TransportClient}
import com.github.ant.network.server.{RpcHandler, StreamManager, TransportServer}
import com.github.ant.rpc.{AbortableRpcFuture, RpcAddress, RpcConf, RpcEndpoint, RpcEndpointAddress, RpcEndpointNotFoundException, RpcEndpointRef, RpcEnv, RpcEnvConfig, RpcEnvFactory, RpcEnvStoppedException, RpcTimeout}
import com.github.ant.serializer.{JavaSerializer, JavaSerializerInstance}
import com.github.ant.util.{ByteBufferInputStream, ByteBufferOutputStream, ThreadUtils}
...
class NettyRpcEnv(val conf: RpcConf,
  ...
  private[netty] val transportConf: TransportConf = AntTransportConf.fromAntConf(
    conf.set("ant.rpc.io.numConnectionsPerPeer", "1"),
    "rpc",
    conf.getInt("ant.rpc.io.threads", 0))
  ...
  private[netty] val clientConnectionExecutor = ThreadUtils.newDaemonCachedThreadPool(
    ...
    conf.getInt("ant.rpc.connect.threads", 64))
